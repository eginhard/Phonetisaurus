Fork for building wheels of the Phonetisaurus Python bindings with all required
libraries and binaries included. Install with: `pip install phonetisaurus-bindings`
